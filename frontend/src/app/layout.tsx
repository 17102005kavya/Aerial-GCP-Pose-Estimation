...
export const metadata: Metadata = {
  title: "GCP Pose Estimation Dashboard",
  description: "EfficientNet-B3 powered keypoint regression and shape classification for Ground Control Points in high-resolution aerial imagery.",
};
